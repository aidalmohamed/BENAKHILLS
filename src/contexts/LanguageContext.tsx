...
const translations: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    "models.01.desc": "Cette première configuration offre 5 chambres spacieuses, dont une suite au rez-de-chaussée, idéale pour recevoir ou pour profiter d'un espace de vie de plain-pied. À l'étage, 4 belles chambres lumineuses complètent la partie nuit, offrant confort et intimité.",
    "models.02.title": "4 Chambres avec Master-room",
    "models.02.desc": "Cette seconde configuration permet toujours de bénéficier d'une suite au rez-de-chaussée, tout en offrant à l'étage trois chambres dont une superbe master room. Les volumes généreux créent un espace nuit élégant et accueillant.",
    ...
    "contact.thankDesc": "Votre message a été transmis avec succès. Notre équipe vous recontacterons dans les plus brefs délais.",
    ...
    "offers.desc": "Découvrez nos dernières villas et terrains disponibles au cœur du domaine Benak Hills.",
    // Footer
  ...
  en: {
    ...
    "concept.p1": "A superb <gold>240 sqm</gold> house, with private pool, built on a plot of <gold>300 sqm and more</gold>, offering a unique and prestigious living environment.",
    "concept.p2": "With titled and fully serviced land, your investment is completely secure. Modular according to your wishes with 4 distinct architectural plans.",
    "concept.p3": "Investing in luxury real estate in Marrakech has never been so serene. Benak Hills redefines Moroccan high-end by combining contemporary architecture and noble finishes.",
    ...
    "domain.desc": "Ideally located, Benak Hills offers quick access to Marrakech's major points of interest while preserving total intimacy.",
    "domain.loc1": "15 minutes from the city center and the mythical Jemaa el-Fna square.",
    "domain.loc1.title": "15 Minutes",
    ...
    "features.desc": "Exceptional quality of life with services and equipment designed for your daily well-being.",
    ...
    "models.01.desc": "This first configuration offers 5 spacious bedrooms, including a ground-floor suite, ideal for hosting. Upstairs, 4 bright bedrooms complete the sleeping area.",
    "models.02.title": "4 Bedrooms with Master Suite",
    "models.02.desc": "This second configuration offers a ground-floor suite, while providing three bedrooms upstairs including a superb master room.",
    ...
    "contact.thankDesc": "Your message has been successfully transmitted. Our team will contact you shortly.",
    ...
    "contact.desc": "Our team is at your disposal to accompany you in your real estate acquisition.",
    "contact.phone": "Phone",
    "contact.email": "Email",
    ...
    "offers.desc": "Discover our latest villas and land available in the heart of the Benak Hills domain.",
    // Footer
    "footer.desc": "Architectural elegance at the service of your serenity. Prestige real estate in Marrakech redefined. Book your future villa now.",
